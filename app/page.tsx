        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Button
                      ...
                      onClick={() => {
                        window.scrollTo({
                          top: 3000,  // Scrolls to 1000 pixels from the top
              ...
              <a href="https://drive.google.com/file/d/1y7Lf6uegdV3sz12hOr1axfgaj5Rd_Zmd/view?usp=sharing"
                target="_blank" 
